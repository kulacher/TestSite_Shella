...
(function($){
      ...
      getProduct: function ($product, success) {
          ...
          if(handle) {
              this.ajax = $.ajax({
                  ...
                  url: (window.location.pathname === '/' ? '' : window.location.pathname) + '/products/' + handle + variant_url,
                  data: {
                      view: 'quick-view'
                  },
                  dataType: 'html',
  ...
  ProductOptions.prototype = $.extend({}, ProductOptions.prototype, {
      ...
      _loadJSON: function ($product, json, callback, animate) {
          ...
          if(json) {
              ...
              var xhr = $.ajax({
                  ...
                  // url: `${window.location.protocol}//${window.location.host}/` + 'products/' + handle,
                  data: {
                      view: 'get_json'
                  },
                  cache: false,
      ...
      _updateFormVariantInput: function ($product, data) {
          const input = $product.get(0).querySelector('[data-js-product-variant-input]');
  
          if(!input) return;
          input.setAttribute('value', data.update_variant.id);
  ...
  class CartData {
      ...
      addItems(items) {
          ...
          // return fetch(`${window.location.protocol}//${window.location.host}/add.js`, requestParams)
